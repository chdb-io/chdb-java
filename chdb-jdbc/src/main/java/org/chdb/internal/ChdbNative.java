...
public final class ChdbNative {
     ...
     *
     * <p>Optional symbol, resolved by {@code dlsym}, because older compatible engines may not
     * export it. A null return means this engine has no classifier and the caller must fall back
     * to {@code StatementShape}'s own analysis.
     *
     ...
     *
     * <p>Optional symbol, like {@link #classifyQuery(long, byte[])}. Not having it is not a
     * failure -- the threads it would join are reaped by process exit either way.
     *
